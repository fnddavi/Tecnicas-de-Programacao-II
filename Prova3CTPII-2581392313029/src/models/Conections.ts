...
const uri = "mongodb://127.0.0.1:27017/tpii_prova3";
...
export default function connect() {
    ...
    mongoose.connection.on("connected", () => console.log("Conexão estabelecida com o MongoDB"));
    ...
    mongoose.connection.on("close", () => console.log("Conexão fechada"));
